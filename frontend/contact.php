...
<head>
    <meta charset="UTF-8">
    <!-- Mobile pe layout adjust hoga -->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Contact Us - Hostel Management</title>
    <!-- Ready UI (cards, grid, buttons) -->
    ...
    <style>
        * {
        ...
        .page-banner {
          ...
          /* sab icons bada size and same color */
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow p-4 mb-4">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">Lovely Professional University,<br>Phagwara, Punjab ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ 144411, India</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow p-4">
                    ...
                    <a href="https://www.instagram.com/lpuuniversity?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="btn btn-sm w-100 mb-2 shadow-none text-start text-white" style="background:#E1306C;">
                    ...
                    <a href="https://youtu.be/b9yLiyhe0XA?si=kE_7V9mQs6KT9fuW" target="_blank" class="btn btn-sm w-100 shadow-none text-start text-white" style="background:#FF0000;">
